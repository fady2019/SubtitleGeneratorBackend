...
from validation.subtitles import subtitle_begin_generation_media_file_validator, subtitle_begin_generation_title_validator
...
def begin_subtitle_generation():
    ...
    data = subtitles_service.generate_subtitle(
        user_id, {"title": request.form.get("title"), "media_file": request.files.get("media_file")}
    )
